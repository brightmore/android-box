...
public class LibVLC {
    ...
    public final static int libvlc_NothingSpecial = 0;
    public final static int libvlc_Opening = 1;
    public final static int libvlc_Buffering = 2;
    public final static int libvlc_Playing = 3;
    public final static int libvlc_Paused = 4;
    public final static int libvlc_Stopped = 5;
    public final static int libvlc_Ended = 6;
    public final static int libvlc_Error = 7;
