...
public class GetChannels extends ListActivity{
    ...
    private static String url_all_channels = "http://localhost/msiptv/get_channels.php";
   ...
   protected void onActivityResult(int requestCode, int resultCode, Intent data) {
    ...
    class LoadAllChannels extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(GetChannels.this);
        ...
        protected String doInBackground(String... args) {
            ...
            JSONObject json = jParser.getJSONFromUrl(url_all_channels);
            ...
            try {
                ...
                if (success == 1) {
                    ...
                    channels = json.getJSONArray(TAG_CHANNELS);
                    ...
                    for (int i = 0; i < channels.length(); i++) {
                        ...
                        String channelname = c.getString(TAG_CHANNELNAME);
                        ...
                        map.put(TAG_CHANNELNAME, channelname);
                        map.put(TAG_MULTICAST, multicast);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                  ...
                  ListAdapter adapter = new SimpleAdapter(
                            GetChannels.this, channelList,
                            R.layout.splashscreen, new String[] { TAG_CHANNELNAME,
                            TAG_MULTICAST},
                            new int[] { R.id.cid, R.id.channelname });
